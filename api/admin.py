...
class ToolAdmin(ImportExportModelAdmin):
    ...
    list_display = ['name', 'rating', 'review_count', 'is_featured', 'startup_friendly', 'is_active']
    list_filter = ['is_active', 'is_featured', 'verified', 'startup_friendly', 'categories']
...
class DealAdmin(ImportExportModelAdmin):
    ...
    list_display = ['tool', 'offer_title', 'discount_percentage', 'expiry_date', 'claims_count', 'featured_deal', 'is_active']
...
class NewsAdmin(admin.ModelAdmin):
    list_display = ['title', 'author', 'category', 'reading_time', 'is_published', 'is_featured', 'published_at']
