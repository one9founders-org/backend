...
# Create categories
categories_data = [
    {'name': 'AI & Machine Learning', 'slug': 'ai-ml', 'description': 'AI-powered tools and ML platforms'},
    ...
    {'name': 'Development', 'slug': 'development', 'description': 'Developer tools and platforms'},
...
tools_data = [
    {
        ...
        'features': ['Natural language processing', 'Code generation', 'Multi-language support'],
