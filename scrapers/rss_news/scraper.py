...
class RSSNewsScraper:
    ...
    def __init__(
        ...
        self.logger = setup_logging(
            "rss_news", Path("logs") if not output_dir else output_dir / "logs"
        )
    ...
    def scrape(self) -> List[Dict[str, Any]]:
        ...
        """
        self.logger.info(
            f"Starting RSS News scrape (limit_per_source={self.limit_per_source})"
        )
        ...
        for source_name, url in RSS_SOURCES.items():
            ...
            try:
                ...
                if feed.bozo:
                    self.logger.warning(
                        f"Possible issue with {source_name} feed: {feed.bozo_exception}"
                    )
                ...
                for entry in entries:
                    ...
                    clean_description = (
                        BeautifulSoup(summary_html, "html.parser")
                        .get_text(separator=" ")
                        .strip()
                    )
                    ...
                    normalized = normalize_item(
                        ...
                        metrics={
                            ...
                            "published": published,
                            "original_summary": summary_html[
                                :500
                            ],  # Keep a bit of HTML for debugging
                        },
